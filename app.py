...
mydb=mysql.connector.connect(host="localhost",user="root",password="uday",database="flaskblog")
with mysql.connector.connect(host="localhost",user="root",password="uday",database="flaskblog"):
    cursor=mydb.cursor(buffered=True)
    cursor.execute("create table if not exists registration(username varchar(50)primary key,mobile varchar(20) unique,email varchar(50) unique,address varchar(80),password varchar(20))")
app=Flask(__name__)
